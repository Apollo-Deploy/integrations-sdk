...
export function mapGooglePlayEvent(notification: GooglePlayDeveloperNotification): IntegrationEvent {
  ...
  if (notification.testNotification) {
    ...
    eventType =
      OTP_TYPES[otp.notificationType] ?? `purchase.type_${otp.notificationType}`;
