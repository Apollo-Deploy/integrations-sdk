...
export const createGooglePlayAdapter = defineAdapter<GooglePlayAdapterConfig>({
  ...
  metadata: {
    description:
      "Manage Android app releases, tracks, and rollouts via the Google Play Developer API.",
    category: "App Stores",
    dateAdded: "2024-06-15",
    iconUrl: {
      light:
        "https://cdn.apollodeploy.com/integrations/google_play_integration_light.svg",
