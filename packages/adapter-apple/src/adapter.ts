  ...
  credentialInputs: [
    {
      ...
      helpText: 'Found in App Store Connect → Users and Access → Integrations → Team Keys.',
    },
    {
      key: 'keyId',
      label: 'Key ID',
    ...
    },
    {
      ...
      helpText: 'Paste the contents of the .p8 key file downloaded from App Store Connect.',
    },
  ],
};
